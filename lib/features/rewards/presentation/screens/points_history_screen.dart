        ...
        body: FutureBuilder<List<PointTransaction>>(
          ...
          builder:
              (
                ...
                final carbon = transactions.fold<double>(
                  0,
                  (sum, transaction) => sum + transaction.carbonSavedKg,
                );
                        ...
                        delegate: SliverChildListDelegate(<Widget>[
                          ...
                          if (transactions.isEmpty)
                            const Padding(
                              ...
                              child: Center(
                                child: Text(
                                  'No points have been earned this month yet.',
                                ),
                              ),
                            ),
                          ...transactions.map(
            ...
            children: <Widget>[
              ...
              Row(
                children: const <Widget>[
                  Text(
                    'Monthly Goal',
                    style: TextStyle(color: Color(0xFFDDF2DF), fontSize: 11),
                  ),
                  Spacer(),
                  Text(
                    '3,240 / 4,000 pts',
              ...
              children: <Widget>[
                ...
                Wrap(
                  ...
                  children: <Widget>[
                    ...
                    _MetricChip(
                      label:
                          '📍 ${transaction.distanceKm.toStringAsFixed(1)} km',
